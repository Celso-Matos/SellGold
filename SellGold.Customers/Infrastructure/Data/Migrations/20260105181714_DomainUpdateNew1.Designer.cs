...
namespace SellGold.Customers.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260105181714_DomainUpdateNew1")]
                    ...
                    b.OwnsMany("SellGold.Customers.Domain.ValueObjects.Address", "Addresses", b1 =>
                        {
                            ...
                            b1.OwnsOne("SellGold.Customers.Domain.ValueObjects.Place", "Place", b2 =>
                                {
                                    ...
                                    b2.HasKey("AddressCustomerId", "AddressId");

                                    b2.ToTable("Addresses");

                                    b2.WithOwner()
                                        .HasForeignKey("AddressCustomerId", "AddressId");
                                });
