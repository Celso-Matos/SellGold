...
namespace SellGold.Contracts.DTOs.Promotions.Models
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual System.Threading.Tasks.Task<PromotionResponse> PromotionsAsync(CreatePromotionCommand body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PromotionResponse> PromotionsAsync(CreatePromotionCommand body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/Promotions"
                    urlBuilder_.Append("api/Promotions");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ActivateAsync(System.Guid promotionId)
        {
            return ActivateAsync(promotionId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ActivateAsync(System.Guid promotionId, System.Threading.CancellationToken cancellationToken)
        {
            if (promotionId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/Promotions/{promotionId}/activate"
                    urlBuilder_.Append("api/Promotions/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(promotionId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class CreatePromotionCommand
    {

        [Newtonsoft.Json.JsonProperty("createPromotionRequest", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CreatePromotionRequest CreatePromotionRequest { get; set; }
