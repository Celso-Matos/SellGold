...
namespace SellGold.Contracts.DTOs.Stock.Models
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual System.Threading.Tasks.Task<StockProductResponse> StockAsync(CreateStockCommand body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StockProductResponse> StockAsync(CreateStockCommand body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<StockProductResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class CreateStockCommand
    {
        ...
        [Newtonsoft.Json.JsonProperty("createStockRequest", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public StockRequest CreateStockRequest { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class StockProductResponse
    {
        ...
        public System.Collections.Generic.ICollection<StockMovementResponse> StockMovement { get; set; }
        ...
        public System.Collections.Generic.ICollection<StockLocationResponse> StockLocation { get; set; }
    ...
    public partial class StockRequest
    {
        ...
        [Newtonsoft.Json.JsonProperty("stockLocationName", Required = Newtonsoft.Json.Required.Always)]
